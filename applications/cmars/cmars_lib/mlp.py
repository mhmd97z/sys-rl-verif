...
class MLPLayer(nn.Module):
    def __init__(self, input_dim, hidden_size, layer_N, use_orthogonal, use_ReLU, _use_feature_normalization=True):
...
class MLPBase(nn.Module):
    def __init__(self, args, obs_shape, cat_self=True, attn_internal=False):
        ...
        print("self._use_feature_normalization: ", self._use_feature_normalization)
