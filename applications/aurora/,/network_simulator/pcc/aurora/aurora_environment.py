...
# import sys
# sys.path.append('aurora_lib')
import aurora_lib.sender_obs as sender_obs
from aurora_lib.network_simulator.constants import BYTES_PER_PACKET, AURORA_ROUND
from aurora_lib.network_simulator.link import Link
from aurora_lib.network_simulator.network import Network
if AURORA_ROUND:
    from aurora_lib.network_simulator.pcc.aurora.aurora_sender_round import AuroraSender
else:
    from aurora_lib.network_simulator.pcc.aurora.aurora_sender import AuroraSender
from aurora_lib.network_simulator.pcc.aurora.schedulers import Scheduler


class AuroraEnvironment(gym.Env):

    def __init__(self, trace_scheduler: Scheduler, history_len: int = 3,
...
register(id='AuroraEnv-v0', entry_point='network_simulator.pcc.aurora.aurora_environment:AuroraEnvironment')
